...
| ⏳ **待追蹤 (Pending Discovery)** | **10699** 款 | 剛進榜或超過 24 小時未偵測，等待爬取中 |
| 💤 **排除中 (No IAP Excluded)** | **4228** 款 | 證實無內購，每 3 天低頻冷卻複檢 |
| ❌ **已失效 (Persistent 404)** | **3193** 款 | 疑似被伺服器阻擋或地區限制，每 30 天極低頻重試 |
| 📦 **總收錄規模 (Total Database)** | **18364** 款 | 當前覆蓋的所有 App Store 行動目錄總量 |
<!-- STATS_END -->
